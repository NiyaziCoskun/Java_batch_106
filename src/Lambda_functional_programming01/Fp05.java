...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println(ortPuanVerilenSayidanBuyukMU(coursesList,75));
        System.out.println( herhangiBirKursAdiKelimeyiİcindeVarmi(coursesList,"kkk"));
    ...
    public static boolean ortPuanVerilenSayidanBuyukMU(List<Courses>list, double x){
    ...
    public static boolean herhangiBirKursAdiKelimeyiİcindeVarmi(List<Courses>list ,String kelime){
    ...
    //4) Liste öğelerini artan düzende ortalama puana
